...
const TournamentMatchSchedulePage = lazy(
  () => import("./pages/tournaments/schedule/TournamentMatchSchedulePage"),
);
        ...
        <Suspense fallback={<Loader />}>
          <Routes>
            ...
            >
              ...
              />
              <Route
                path="/tournaments/:id/match-schedule"
                element={<TournamentMatchSchedulePage />}
              />
