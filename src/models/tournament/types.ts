...
=======
export const backendTournamentDetailSchema = z
  .object({
    id: z.string(),
    name: z.string(),
  ...
  .transform(normalizeMemberRange);
>>>>>>> a9ad5c2 (add record-score QR flow and live-match navigation integration)
...
=======
export type TournamentScheduleMatch = z.infer<
  typeof tournamentScheduleMatchSchema
>;
export type TournamentScheduleInfo = z.infer<
  typeof tournamentScheduleInfoSchema
>;
export type TournamentMatchesResponse = z.infer<
  typeof tournamentMatchesResponseSchema
>;
export type TournamentLiveMatchItem = z.infer<
  typeof tournamentLiveMatchItemSchema
>;
export type TournamentLiveMatchResponse = z.infer<
  typeof tournamentLiveMatchResponseSchema
>;
export type RecordTournamentMatchScoreInput = z.infer<
  typeof recordTournamentMatchScoreInputSchema
>;
export type RecordTournamentMatchScoreResponse = z.infer<
  typeof recordTournamentMatchScoreResponseSchema
>;
export type TournamentScheduleInput = z.infer<
  typeof tournamentScheduleInputSchema
>;
export type TournamentScheduleParticipant = z.infer<
  typeof tournamentScheduleParticipantSchema
>;
export type TournamentScheduleResponse = z.infer<
...
>;
export type GenerateTournamentScheduleInput = z.infer<
  typeof generateTournamentScheduleInputSchema
>;
export type GenerateTournamentScheduleResponse = z.infer<
  typeof generateTournamentScheduleResponseSchema
>;
export type GenerateTournamentDoublesPairsInput = z.infer<
  typeof generateTournamentDoublesPairsInputSchema
>;
export type TournamentSchedulePairPlayer = z.infer<
  typeof tournamentSchedulePairPlayerSchema
>;
export type GenerateTournamentDoublesPairsResponse = z.infer<
  typeof generateTournamentDoublesPairsResponseSchema
>;
export type BackendTournamentDetail = z.infer<
  typeof backendTournamentDetailSchema
>;
export type BackendTournamentDetailResponse = z.infer<
  typeof backendTournamentDetailResponseSchema
>;
>>>>>>> a9ad5c2 (add record-score QR flow and live-match navigation integration)
